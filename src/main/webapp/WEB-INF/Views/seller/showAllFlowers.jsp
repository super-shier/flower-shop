            ...
            <div class="box-border member-r">
                <div class="order-wrap">
                    ...
                    <div class="order-panel">
                        <div class="hd" style="padding-left: 30px">
                            <ul class="order-list">
                                <li class="number" style="position:relative;left:110px">id</li>
                                <li class="consignee">名称</li>
                                <li class="consignee">价格</li>
                                <li class="consignee">花材</li>
                                <li class="consignee">类型</li>
                                <li class="consignee">用途</li>
                                <li class="consignee">操作</li>
                            </ul>
                        </div>
                        <div class="bd">
                            <ul class="order-list">
                                <li class="img-box">
                                    <a href=""><img src="../assets/Images/9012009.jpg_80x87.jpg" height="56" width="50"></a>
                                </li>
                                <li class="consignee"><a href="">1</a></li>
                                <li class="consignee">香皂玫瑰</li>
                                <li class="consignee">
                                    <span class="price-sign">¥</span>
                                    <span class="price-num">667</span>
                                </li>
                                <li class="consignee">玫瑰</li>
                                <li class="consignee">花盒</li>
                                <li class="consignee">婚庆鲜花</li>
                                <li class="consignee">
                                    <a href="">查看</a>
                                </li>
                            </ul>
            ...
            <div class="box-border">
                ...
                <ul class="bd">
                    ...
                    <li>
                        ...
                        <ul>
                            <li id=""><a href="${pageContext.request.contextPath}/user/showAllFlowers">全部商品</a></li>
                            <li id=""><a href="${pageContext.request.contextPath}/user/addFlower">新货上架</a></li>
                        </ul>
                    </li>
                    <li>
                        <span class="ico ico-member2"></span>订单信息
                        <ul>
                            <li id="myOrderItem"><a href="${pageContext.request.contextPath}/user/showOrders">已售订单</a>
                            </li>
