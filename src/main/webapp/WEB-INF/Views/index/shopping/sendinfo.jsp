    ...
    <div class="container">
            ...
            <div class="bd">
                        ...
                        <div id="showAddress">
                            <div class="address-bar">
                                ...
                                <div class="address">
                                    ...
                                    <i class="wzsj"><span id="address1928994_1">山西</span> <span id="address1928994_2">太原市</span>
                                        <span id="address1928994_area">小店区</span> <span
                                                id="address1928994_3">黄河小学18号</span></i>
                                    <i><span id="address1928994_4">17671751371</span> <span
                                            id="address1928994_5"></span></i>
                                    <i style="color: rgb(255, 255, 255); background: none repeat scroll 0% 0% rgb(184, 184, 184); line-height: 22px; padding: 0px 5px; margin-top: 4px;">
                                        默认地址</i><span id="address1928994_6" style="display: none;">0</span>
                    ...
                    <div class="item-bd">
                        <div class="form-inline order-form" style="display: none;" id="OrderPersonInfo">
                            <div class="form-group">
                                <input class="form-control input-sm" id="realname" name="realname" value="张洋"
                                       placeholder="您的姓名" style="width: 140px;" maxlength="15" type="text">
                            </div>
                            <div class="form-group">
                                <input class="form-control input-sm" id="phone" name="phone" value="17671751371"
                                       placeholder="手机号码或电话" style="width: 140px;" maxlength="25" type="text">
                            </div>
                            <div class="form-group">
                                <input class="form-control input-sm" id="Email" name="Email" value="846965599@qq.com"
                                       readonly="" style="width: 200px;" type="text">
                            </div>
                            <button class="btn btn-primary btn-sm" type="button" onclick="DoOrderPersonInfo()">确定
                            </button>
                        </div>
                ...
                <div class="order-item">
                    <div class="order-item-inner date">
                        ...
                        <div class="item-bd input-date" id="selectDay">
                            <input class="form-control input-sm" id="send_riqi" name="send_riqi" value="2018-4-"
                                   type="text">
                            <span class="ico-riqi" id="xingqi"></span>
                            <i class="ico ico-calendar" id="rlTu"></i>
                        </div>
                        <div id="divShow"
                             style="position: absolute; z-index: 9999; width: 400px; height: auto; display: none; background: none repeat scroll 0% 0% rgb(255, 255, 255); border: 1px solid rgb(255, 207, 98);">
                            <iframe src="index_1.html" id="dialogIframe" name="dialogIframe" marginwidth="0"
                                    marginheight="0" scrolling="no"
                                    style="border: 0px none; width: 100%; height: 320px;" frameborder="0"></iframe>
                        </div>
                    </div>
                    <div class="order-item-inner time">
                        ...
                        <div class="item-bd">
                            <ul class="selects-list" id="timeFrame">
                                ...
                                <li data-popover="true" data-content="<span class='text-primary'>08:30-12:00</span>"
                                    id="timeSelect1">上午<i class="ico ico-check"></i></li>
                                <li data-popover="true" data-content="<span class='text-primary'>12:00-18:00</span>"
                                    id="timeSelect2">下午<i class="ico ico-check"></i></li>
                                <li data-popover="true" data-content="<span class='text-primary'>18:00-21:00</span>"
                                    id="timeSelect3">晚上<i class="ico ico-check"></i></li>
                                <li data-popover="true"
                                    data-content="<span class='text-primary'>定时服务+30元(非节日)，误差±15分钟。</span>"
                                    id="timeSelect4">定时<i class="ico ico-check"></i></li>
                                <span style="float: left; display: none;" id="selectTimes">
                                        <select id="select_hours" name="select_hours" style="height: 30px; width: 50px;"
                                                onchange="checkSendDate();">
                                        ...
                                        <select id="select_minutes" name="select_minutes"
                                                style="height: 30px; width: 50px;" onchange="checkSendDate();">
                    ...
                    <p class="error-info" id="SendDate_ErrorInfo" style="display: none;"><span class="text-primary"
                                                                                               id="dateErrMsg">特别提醒：日期格式不正确,请选择正确的日期格式, 例如：2015-5-15</span>
                    </p>
                    <p class="error-info" id="jieri_notsend" style="display: none;"></p>
                    <p class="error-info" id="jieri_notice" style="display: none;"></p>
                    <p class="error-info" id="fp_info" style="display: none;">定时服务<span class="text-primary">+30元</span>(非节日)，误差<span
                            class="text-primary">±15</span>分钟。(如果付款时间在21:00-8:30，定时时间需晚于10点)</p>
                </div>
                ...
                <div class="order-item">
                    <div class="order-item-inner card-text">
                        ...
                        <div class="item-bd" id="cardText">
                            <textarea maxlength="400" class="form-control" id="words" name="words" rows="5"
                                      placeholder="贺卡留言+署名"></textarea>
                    ...
                    <div class="order-item-inner card-option">
                        ...
                        <div class="tab-content card-content">
                            <ul class="tab-pane in active" id="cardPane00">
                                <li data-popover="true"
                                    data-content="亲爱的妈妈：虽然我无法阻止岁月为你增添白发，却能够多为你带来一份喜悦。希望你有一个好的身体，有一个好的心态，过健康快乐的日子。愿鲜花带给你美丽的心情，母亲节快乐！">
                                    1.亲爱的妈妈：虽然我无法阻止岁月为你增添白发，却能够多为你带来一份喜悦。希望你有一个好的身体，有一个好的心态，过健康快乐的日子。愿鲜花带给你美丽的心情，母亲节快乐！
                                </li>
                                <li data-popover="true"
                                    data-content="“洗衣做饭忙不完，每日忙碌不着闲，历经风霜添白发，勤劳持家不知烦”。作为儿子女儿的我们，深知您每天的辛苦忙碌，但作为儿子女儿的我们，同样要给您幸福，祝您节日快乐，幸福万年长。">
                                    2.“洗衣做饭忙不完，每日忙碌不着闲，历经风霜添白发，勤劳持家不知烦”。作为儿子女儿的我们，深知您每天的辛苦忙碌，但作为儿子女儿的我们，同样要给您幸福，祝您节日快乐，幸福万年长。
                                </li>
                                <li data-popover="true"
                                    data-content="天空广阔，比不上母亲的博爱广阔；太阳温暖，比不上母亲的真情温暖；鲜花灿烂，比不上母亲的微笑灿烂；彩虹鲜艳，比不上母亲的快乐鲜艳。祝母亲节快乐!">
                                    3.天空广阔，比不上母亲的博爱广阔；太阳温暖，比不上母亲的真情温暖；鲜花灿烂，比不上母亲的微笑灿烂；彩虹鲜艳，比不上母亲的快乐鲜艳。祝母亲节快乐!
                                </li>
                                <li data-popover="true"
                                    data-content="天地之间，母爱最真；岁月之中，母爱最久；时光荏苒，母爱不朽。母亲节到了，祝福你幸福吉祥常相伴，开心美丽赛鲜花！">
                                    4.天地之间，母爱最真；岁月之中，母爱最久；时光荏苒，母爱不朽。母亲节到了，祝福你幸福吉祥常相伴，开心美丽赛鲜花！
                                </li>
                                <li data-popover="true"
                                    data-content="亲爱的妈妈，虽然平时一直和你吵吵闹闹，也不常表露对你的感谢，其实心里始终对您有感激。母亲节了，祝您身体健康，永远快乐。">
                                    5.亲爱的妈妈，虽然平时一直和你吵吵闹闹，也不常表露对你的感谢，其实心里始终对您有感激。母亲节了，祝您身体健康，永远快乐。
                                </li>
                                <li data-popover="true"
                                    data-content="妈妈：母亲节快乐！感谢您给了我生命，更给了我满满的爱，让我无比幸福。总能在您身上感受到对生活的激情，又不失温和智慧，一切都那么美好。祝愿您身体健康，天天开心！">
                                    6.妈妈：母亲节快乐！感谢您给了我生命，更给了我满满的爱，让我无比幸福。总能在您身上感受到对生活的激情，又不失温和智慧，一切都那么美好。祝愿您身体健康，天天开心！
                                </li>
                                <li data-popover="true"
                                    data-content="亲爱的妈妈：不想时间过得那么快，因为我想有再多一点时间回家陪着你。不要觉得自己老了，在我心里，永远是那么青春靓丽！不要过分操劳，咱家事事都顺心如意！妈妈节日快乐，我们爱你！祝妈妈永远年轻漂亮！身体健康！">
                                    7.亲爱的妈妈：不想时间过得那么快，因为我想有再多一点时间回家陪着你。不要觉得自己老了，在我心里，永远是那么青春靓丽！不要过分操劳，咱家事事都顺心如意！妈妈节日快乐，我们爱你！祝妈妈永远年轻漂亮！身体健康！
                                </li>
                                <li data-popover="true"
                                    data-content="妈妈，当我难过时，您比我还难过。当我快乐时，您比我还高兴。在我成长过程中，您给了我所有的爱！我经常气你，但是你从不埋怨我。我经常懒惰，但是你还是容忍了我。您是这个世界上最爱我的人，我爱你，妈妈，全心全意！">
                                    8.妈妈，当我难过时，您比我还难过。当我快乐时，您比我还高兴。在我成长过程中，您给了我所有的爱！我经常气你，但是你从不埋怨我。我经常懒惰，但是你还是容忍了我。您是这个世界上最爱我的人，我爱你，妈妈，全心全意！
                                </li>
                                <li data-popover="true"
                                    data-content="愿时光温柔不曾在您身上停留；愿岁月静好幸福始终在您身边环绕。感恩您二十余载的含辛茹苦，母亲节快乐！">
                                    9.愿时光温柔不曾在您身上停留；愿岁月静好幸福始终在您身边环绕。感恩您二十余载的含辛茹苦，母亲节快乐！
                                </li>
                                <li data-popover="true"
                                    data-content="曾经未能百般体贴，看您慢慢老去未能抚平身心的伤痛。只是希望您能像鲜花一样每天充满活力和艳丽，爱你妈妈！">
                                    10.曾经未能百般体贴，看您慢慢老去未能抚平身心的伤痛。只是希望您能像鲜花一样每天充满活力和艳丽，爱你妈妈！
                                </li>
                                <li data-popover="true"
                                    data-content="世界上最了解我的人就是你，你是我的妈妈，也是我的朋友、我的知己，更是生命中最中要的人，老妈我爱你！母亲节快乐！在我无法陪伴左右的日子里，愿老妈每一天都平安健康快乐！">
                                    11.世界上最了解我的人就是你，你是我的妈妈，也是我的朋友、我的知己，更是生命中最中要的人，老妈我爱你！母亲节快乐！在我无法陪伴左右的日子里，愿老妈每一天都平安健康快乐！
                                </li>
                                <li data-popover="true"
                                    data-content="亲爱的妈妈，今天是母亲节，感谢母亲多年养育恩，感谢母亲多年教诲情。走遍天涯海角，您在的地方才是永远的家；听遍千言万语，您说的话才是拨动心铉的金玉；吃遍四面八方，您做的饭菜才是最香；看遍人情冷暖，您给的关心才是最真挚的爱。母亲节，愿您节日快乐，健康长寿！">
                                ...
                                <li data-popover="true"
                                    data-content="假如我是个诗人，我就要写一首诗，来赞美您的爱；假如我是画家，我就要用各种颜色，描绘出你的慈容。但我什么都不是!我想说的是：妈咪，我爱你，您辛苦了！永远爱你！">
                                    13.假如我是个诗人，我就要写一首诗，来赞美您的爱；假如我是画家，我就要用各种颜色，描绘出你的慈容。但我什么都不是!我想说的是：妈咪，我爱你，您辛苦了！永远爱你！
                                </li>
                                <li data-popover="true"
                                    data-content="一向不善在您面前表达的我，也没有给你说过什么感谢的话，但您对我的关心和爱意，点点滴滴都记在我心头，在这特别的日子送上我特别的问候，祝：您节日快乐，健康永远">
                                    14.一向不善在您面前表达的我，也没有给你说过什么感谢的话，但您对我的关心和爱意，点点滴滴都记在我心头，在这特别的日子送上我特别的问候，祝：您节日快乐，健康永远
                                </li>
                                <li data-popover="true"
                                    data-content="母亲像杯茶，把清香送给我们，把苦涩留给自己；母亲是把伞，把舒适留给我们，把风雨挡在身上；母亲是世上最爱你和最值得你爱的人。在母亲节的日子里，祝福妈妈健康长寿 ！！">
                                    15.母亲像杯茶，把清香送给我们，把苦涩留给自己；母亲是把伞，把舒适留给我们，把风雨挡在身上；母亲是世上最爱你和最值得你爱的人。在母亲节的日子里，祝福妈妈健康长寿 ！！
                                </li>
                                <li data-popover="true"
                                    data-content="许多许多的旅途，可以用脚步丈量，更多更多的遥远都可以用眼睛张望，唯有思念的距离，是用牵挂的长丝织成的网，或密或疏，或短或长，如同种在心里的一株玫瑰，有一点刺痛，却恒久留香。祝妈妈节日快乐，永远美丽！">
                                    16.许多许多的旅途，可以用脚步丈量，更多更多的遥远都可以用眼睛张望，唯有思念的距离，是用牵挂的长丝织成的网，或密或疏，或短或长，如同种在心里的一株玫瑰，有一点刺痛，却恒久留香。祝妈妈节日快乐，永远美丽！
                                </li>
                                <li data-popover="true"
                                    data-content="如果这个世界上有一百个人爱你，那么爱你最深的一定是你的妈妈。如果这个世界上有十个人爱你，那么爱你最深的一定是你的妈妈。如果这个世界上只有一个人爱你，那么这个人，一定是你的妈妈。今天母亲节，不要吝啬对这个世界上最爱你的人说一句：妈妈，我爱你。">
                            ...
                            <ul class="tab-pane" id="cardPane01">
                                <li data-popover="true"
                                    data-content="遇到你我感到很幸福，但是我不能成为世界上最幸福的人，因为我们在一起，我要让你成为世界上最幸福的人。">
                                ...
                                <li data-popover="true"
                                    data-content="我多么希望，有一个门口，早晨，阳光照在草上，我们站着，扶着自己的门扇，门很低，但太阳是明亮的。草在结它的种子，风在摇它的叶子，我们站着，不说话，就十分美好。">
                                    3.我多么希望，有一个门口，早晨，阳光照在草上，我们站着，扶着自己的门扇，门很低，但太阳是明亮的。草在结它的种子，风在摇它的叶子，我们站着，不说话，就十分美好。
                                </li>
                                <li data-popover="true"
                                    data-content="如果世界上曾经有那个人出现过，其他人都会变成将就，而我，不愿意将就。没遇到爱时，它是一个遥不可及的幻梦，遇到爱之后，它是一份可以被触碰的美好，不善言辞的我，爱上了你后，突然有很多话想说给你听..">
                                ...
                                <li data-popover="true"
                                    data-content="亲爱的：在这特别的日子，我只能用心去默默地想你、爱你。只想告诉你：永远深爱着你，希望你每年的今天都能过一个快乐的生日。">
                            ...
                            <ul class="tab-pane" id="cardPane02">
                                ...
                                <li data-popover="true"
                                    data-content="不是所有人都能掏心掏肺，不是所有的路过都是风景，不是所有的擦肩都是过客。但无论是对朋友还是爱人，只要是在乎我的，我都会加倍珍惜！">
                                ...
                                <li data-popover="true"
                                    data-content="朋友就是那种不需要时刻想起，永远也不会忘记的人，当我需要的时候，还没有讲，你已来到我的身边。不过有你的做伴使我不再感到渺小和孤独。">
                                ...
                                <li data-popover="true"
                                    data-content="人逢知己千杯少，难得在漫漫人生路上能认识你，在一起走过的日子，非常的感谢你给我的帮助，我始终不能忘记我们友谊，不能忘记我们在一起的点点滴滴，很想说有你真好，祝福你，我的朋友。">
                            ...
                            <ul class="tab-pane" id="cardPane03">
                                <li data-popover="true"
                                    data-content="引一缕清风，为妈妈带去轻松；采一缕阳光，为妈妈送去芬芳；掬一捧清水，为妈妈消去疲惫；送一束鲜花，为妈妈奉上祝福。祝妈妈生日快乐！">
                                    1.引一缕清风，为妈妈带去轻松；采一缕阳光，为妈妈送去芬芳；掬一捧清水，为妈妈消去疲惫；送一束鲜花，为妈妈奉上祝福。祝妈妈生日快乐！
                                </li>
                                <li data-popover="true"
                                    data-content="美丽动人可爱迷人的妈妈：生日快乐！青春永驻！虽然不能陪伴在你身边，我的心一直陪伴着你，我爱你，妈妈。">
                                    2.美丽动人可爱迷人的妈妈：生日快乐！青春永驻！虽然不能陪伴在你身边，我的心一直陪伴着你，我爱你，妈妈。
                                </li>
                                <li data-popover="true"
                                    data-content="“洗衣做饭忙不完，每日忙碌不着闲，历经风霜添白发，勤劳持家不知烦”。作为儿子女儿的我们，深知您每天的辛苦忙碌，但作为儿子女儿的我们，同样要给您幸福，祝您生日快乐，幸福万年长。">
                                    3.“洗衣做饭忙不完，每日忙碌不着闲，历经风霜添白发，勤劳持家不知烦”。作为儿子女儿的我们，深知您每天的辛苦忙碌，但作为儿子女儿的我们，同样要给您幸福，祝您生日快乐，幸福万年长。
                                </li>
                                <li data-popover="true"
                                    data-content="从一个城市到另一个城市，只有靠自己努力。学会长大，学会承受，学会哭过之后，还可以微笑地拥抱爸爸妈妈。因为你们一直是我的守护神！让我走到哪里都不会怕！">
                                    4.从一个城市到另一个城市，只有靠自己努力。学会长大，学会承受，学会哭过之后，还可以微笑地拥抱爸爸妈妈。因为你们一直是我的守护神！让我走到哪里都不会怕！
                                </li>
                                <li data-popover="true"
                                    data-content="谢谢您做的一切，双手撑起我们的家，总是竭尽所有把最好的给我们。不要再为我们而担心啦，你牵挂的孩子长大了。">
                                    5.谢谢您做的一切，双手撑起我们的家，总是竭尽所有把最好的给我们。不要再为我们而担心啦，你牵挂的孩子长大了。
                                </li>
                                <li data-popover="true"
                                    data-content="岁月总是越来越短，生日总是越来越快。留不住的时光使您走向人生的至善，留得住的贺卡捎去的是我深深的怀念。真心希望晚辈的祝福带给您欢乐！">
                                    6.岁月总是越来越短，生日总是越来越快。留不住的时光使您走向人生的至善，留得住的贺卡捎去的是我深深的怀念。真心希望晚辈的祝福带给您欢乐！
                                </li>
                                <li data-popover="true"
                                    data-content="听说神无法无处不在，所以创造了妈妈。即使到了妈妈的年龄，妈妈的妈妈仍然是妈妈的守护神。妈妈这个词，只是叫一叫，也觉得喉间哽咽。妈妈，最有力量的名字；妈妈，祝你永远年轻。">
                                ...
                                <li data-popover="true"
                                    data-content="您用优美的年轮，编成一册散发油墨清香的日历；年年，我都会在日历的这一天上，用深情的想念，祝福您的生日。">
                                    9.您用优美的年轮，编成一册散发油墨清香的日历；年年，我都会在日历的这一天上，用深情的想念，祝福您的生日。
                                </li>
                                <li data-popover="true"
                                    data-content="亲爱的妈妈：您曾用您坚实的臂弯为我撑起一片蓝天；而今，我也要用我日益丰满的羽翼为您遮挡风雨。妈妈，我永远爱您！生日快乐！祝我的美女妈妈越来越青春，身体健康，瘦成闪电，未来的我可以每个假期带你出去纵横~ ">
                ...
                <div class="order-item">
                    ...
                    <div class="item-bd">
                        <ul class="selects-list" id="payWay">
                            <li class="active" id="payway0" data-popover="true"
                                data-content="支持：支付宝、微信扫码、财付通、易宝支付、PayPal；以及工行、农行、建行、中行、招行、交行等10多家主要银行直付。">网上支付<i
                                    class="ico ico-pop"></i><i class="ico ico-check"></i></li>

                            <li id="payway3" data-popover="true"
                                data-content="不与其他优惠同时使用，以商品购买价计价。<br /><a href='/help/lipinka_check.htm' target='_blank'><u>验证卡有效性</u></a>">
                                礼品卡支付<i class="ico ico-check"></i><i class="ico ico-pop"></i></li>
                            ...
                            <span id="shangmen" class="checkbox-wrap form-inline" style="display: none;">上门收款地址：<input
                                    name="address" id="address" value="" class="form-control input-sm"
                                    placeholder="如不是订购人请同时注明联系人及手机" style="width: 230px;" maxlength="120"
                                    type="text"></span>
                        </ul>
                    </div>
                </div>
                ...
                <div class="checkbox-wrap form-inline" style="margin-bottom: 6px;">
                    ...
                    <div class="form-group special-form hidden">
                        <input value="" class="form-control input-sm" id="quest" name="quest"
                               placeholder="选填，如有其他要求请注明,我们尽量满足，120字以内:)" style="width: 500px;" maxlength="120"
                               type="text">
                    </div>
                </div>
                <!-- 特殊要求 End -->
                ...
                <div class="checkbox-wrap form-inline">
                    <div class="checkbox">
                        <label>
                            <input class="invoice-checkbox" name="ShowFInfo1" id="ShowFInfo1" value="1" type="checkbox">
                            我要发票
                        </label>
                    </div>
                    ...
                    <div class="invoice-form hidden" id="fpinputinfo">
                        ...
                        <div class="invoice-bd">
                            <p>
                                <label id="danwei"><input name="tax" style="position: relative; top: 2px;" value="0"
                                                          checked="checked" type="radio">单位</label>
                                <label id="geren"><input name="tax"
                                                         style="position: relative; top: 2px; margin-left: 5px;"
                                                         value="1" type="radio">个人</label>
                            ...
                            <p class="error-info" style="display: none; margin: 0px 0px 10px;"><span
                                    class="text-primary"></span></p>
                            <div class="form-group">
                                <input name="fp_posttype" value="快递" id="fp_posttype_2" type="hidden">
                                <input class="form-control input-sm" id="fp_info01" name="fp_info01" value=""
                                       placeholder="单位全称" style="width: 345px;" maxlength="50" type="text"><input
                                    name="yfp_info01" id="yfp_info01" value="" size="30" maxlength="25" type="hidden">
                            </div>
                            <div class="form-group">
                                <input value="" class="form-control input-sm" id="fp_info04" name="fp_info04"
                                       placeholder="纳税人识别号" style="width: 345px;" maxlength="30" type="text">
                                <input name="yfp_info04" id="yfp_info04" value="" size="30" maxlength="30"
                                       type="hidden">
                            </div>
                            <div class="form-group">
                                <div class="form-inline" style="width: 500px;">
                                    <input class="form-control input-sm" placeholder="收件人" value="" name="fp_info03"
                                           id="fp_info03" style="width: 170px; float: left; margin-right: 5px;"
                                           maxlength="50" type="text">
                                    <input name="yfp_info03" id="yfp_info03" value="" size="30" maxlength="25"
                                           type="hidden">
                                    <input class="form-control input-sm" name="fp_info02a" id="fp_info02a" value=""
                                           placeholder="手机或电话" style="width: 170px;" maxlength="25" type="text">
                                    <input name="yfp_info02a" id="yfp_info02a" value="" size="30" maxlength="25"
                                           type="hidden">
                                </div>
                            </div>
                            <div class="form-group" style="margin-bottom: 8px;">
                                <input name="fp_info02" id="fp_info02" value="" class="form-control input-sm"
                                       placeholder="详细地址（请完整填写省、市、区等信息，以保证快递顺利送达）" style="width: 500px;" maxlength="122"
                                       type="text"><input name="yfp_info02" id="yfp_info02" value="" size="30"
                                                          maxlength="25" type="hidden">
                            </div>

                            <div class="form-group" style="width: 500px; margin-bottom: 0px;">
                                <label><input name="FPDefault" id="FPDefault" value="1" checked="checked"
                                              style="margin-right: 5px;" type="checkbox">存为常用发票信息</label>
                            </div>
                            <div class="form-group">
                                <button type="button" class="btn btn-default btn-tinge" onclick="SaveFPInfo()">保存发票信息
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="checkbox-wrap form-inline" style="display: block;">
                    <div class="checkbox">
                        <label>
                            <input class="voucher-checkbox" id="aIsUseLiquan" name="aIsUseLiquan" value="1"
                                   type="checkbox"> 我有优惠券
                        </label>
                        <a id="canUseCouponCnt" style="border-bottom: 1px solid rgb(255, 102, 0); display: none;"
                           href="javascript:void(0)" onclick="UseCouponFrame()">可用0张</a>

                    </div>
                    <div id="divlqcode" class="form-group voucher-form hidden">
                        <input class="form-control input-sm" name="lq_code" id="lq_code" value="" placeholder="请输入优惠券号"
        ...
        <div class="cart-panel check">
            ...
            <div class="bd" id="Products">
                <ul class="order-list">
                    <li class="img-box"><a href="https://www.hua.com/product/9012009.html" target="_top"><img
                            src="../../assets/Images/9012009.jpg_80x87.jpg" height="56" width="50"></a></li>
                    <li class="product">
                ...
                <ul class="order-list">
                    <li class="img-box"><a href="https://www.hua.com/product/9012089.html" target="_top"><img
                            src="../../assets/Images/9012089.jpg_80x87.jpg" height="56" width="50"></a></li>
                    <li class="product">
        ...
        <div class="submit-order">
            ...
            <button class="btn btn-primary btn-lg" type="button" onclick="return CheckForm()" id="DoSubmit">提交订单
            </button>

            <button class="btn btn-primary btn-lg" type="button" id="Submiting" disabled="disabled"
                    style="display: none;">提交中,请等待...
            </button>
...
<div class="footer-nav">
    <a href="https://www.hua.com/">首页</a> <b>|</b> <a href="https://www.hua.com/profile/about.htm"
                                                      target="_top">关于我们</a> <b>|</b> <a
        href="https://www.hua.com/profile/media.html" target="_top">媒体报道</a> <b>|</b> <a
        href="https://www.hua.com/profile/contact.htm" target="_top">联系方式</a> <b>|</b> <a
        href="https://www.hua.com/qiyetuangou/" target="_top">企业团购</a> <b>|</b> <a href="https://www.hua.com/liansuo/"
                                                                                   target="_top">花店入驻</a> <b>|</b> <a
        href="https://www.hua.com/member/payment/balancefill" target="_top">在线补款</a> <b>|</b> <a class="last-child"
                                                                                                 href="https://www.hua.com/profile/why_choose_us.htm"
                                                                                                 target="_top">为什么选择中国鲜花礼品网</a>
</div>
<!-- 尾部导航 End -->
<!-- 通用尾部 -->
<footer>
    <div class="auth">
        ...
        <a href="https://ss.knet.cn/verifyseal.dll?sn=e15041744030058395oqbo000000&amp;ct=df&amp;a=1&amp;pa=0.8817607406526804"
           target="_top"><img style="height: 40px;" src="../../assets/Images/cxwz.png"></a>
        <a href="https://search.szfw.org/cert/l/CX20130306002238002312" target="_top"><img
                src="../../assets/Images/cxwz.gif" height="40" width="112"></a>
        <a href="http://www.anquan.org/authenticate/cert/?site=www.hua.com&amp;at=realname" rel="nofollow"
           target="_top"><img src="../../assets/Images/smyz.gif" height="40" width="106"></a>
        <img src="../../assets/Images/slogan.png" height="50" width="212">
        <a href="https://www.hua.com/member/payment/fillbyalipay?order_no=&amp;total_fee=" rel="nofollow" target="_top"><img
                src="../../assets/Images/zfb.gif" height="49" width="96"></a>
        <a href="https://www.hua.com/profile/news_20111110.htm" target="_top"><img src="../../assets/Images/100.jpg"
                                                                                   height="49" width="150"></a>
    </div>
    <p><a href="https://www.hua.com/profile/ChinaFlowerAssociation.htm" rel="nofollow" target="_top" title="中国花卉协会会员">中国花卉协会会员</a>
        <a href="https://www.hua.com/profile/chinaECA.htm" rel="nofollow" target="_top">中国电子商务协会会员</a> ICP经营许可证：<a
                href="https://www.hua.com/profile/ICP.htm" rel="nofollow" target="_top">粤B2-20050744</a> <b>|</b> <a
                href="http://www.miibeian.gov.cn/" rel="nofollow" target="_top">粤ICP备09171662号</a> Copyright © 2005-2018
    </p>
