...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../assets/Css/order.css" media="all">
</head>
<body class="home">
<!-- 顶部导航 -->
...
<!-- 导航 End -->
<div class="container">
    <div class="breadcrumbs"><a href="https://www.hua.com/">首页</a> &gt; <a
            href="https://www.hua.com/Member/MemberCenter/">会员中心</a></div>
    <div class="wrapper about">
                ...
                <div class="order-wrap">
                    ...
                    <div class="order-panel">
                        ...
                        <div class="bd">
                            <ul class="order-list">
                                <li class="img-box">
                                    <a href="https://www.hua.com/Member/Order/Detail?orderid=221194544&amp;pt=2018-04-27"><img
                                            src="../assets/Images/9012009.jpg_80x87.jpg" height="56" width="50"></a>
                                </li>
                                <li class="number"><a
                                        href="https://www.hua.com/Member/Order/Detail?orderid=221194544&amp;pt=2018-04-27">221194544</a>
                                </li>
                                ...
                                <li class="operate">
                                    <a href="https://www.hua.com/Member/Order/Detail?orderid=221194544&amp;pt=2018-04-27">查看</a><span>|</span><a
                                        href="javascript:OrderOper('221194544','cancel');"> 取消 </a>
                                    <a href="https://www.hua.com/Member/Payment/BalanceFill?orderid=221194544&amp;orderamount=667"
                                       class="btn btn-primary btn-sm">付款</a>
                                </li>
                            </ul>
                            <ul class="order-list">
                                <li class="img-box">
                                    <a href="https://www.hua.com/Member/Order/Detail?orderid=221148376&amp;pt=2018-04-27"><img
                                            src="../assets/Images/9012072.jpg_80x87.jpg" height="56" width="50"></a>
                                </li>
                                <li class="number"><a
                                        href="https://www.hua.com/Member/Order/Detail?orderid=221148376&amp;pt=2018-04-27">221148376</a>
                                </li>
                                <li class="consignee">zu</li>
                                <li class="order-price">
                                    <span class="price-sign">¥</span>
                                ...
                                <li class="state">待付款</li>
                                <li class="operate">
                                    <a href="https://www.hua.com/Member/Order/Detail?orderid=221148376&amp;pt=2018-04-27">查看</a><span>|</span><a
                                        href="javascript:OrderOper('221148376','cancel');"> 取消 </a>
                                    <a href="https://www.hua.com/Member/Payment/BalanceFill?orderid=221148376&amp;orderamount=189"
                                       class="btn btn-primary btn-sm">付款</a>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="pull-left w210 r970" id="containerBody">
            <div class="box-border">
                ...
                <ul class="bd">
                    <li id="memberCenterItem"><a href="https://www.hua.com/Member/MemberCenter/"
                                                 style="font-size: 12px;"><span class="ico ico-member1"></span>会员首页</a>
                    </li>
                    <li>
                        <span class="ico ico-member2"></span>订单信息
                        <ul>
                            <li class="active" id="myOrderItem"><a href="https://www.hua.com/Member/Order/">我的订单</a>
                            </li>
                            <li id="cancelOrderItem"><a href="https://www.hua.com/Member/Order/?zt=-1">已取消订单</a></li>
                            <li id="myEvaluationItem"><a href="https://www.hua.com/Member/Order/ReviewList">我的评价</a>
                            </li>
                            <li id="myAttentionItem"><a href="https://www.hua.com/Member/Order/MyAttention">我的收藏</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li id="scoresExchangeItem"><a
                                    href="https://www.hua.com/Member/Payment/ScoresExchange">积分兑换</a></li>
                        </ul>
                    </li>
                    <li>
                        <span class="ico ico-member4"></span>账户设置
                        <ul>
                            <li id="personInfoItem"><a
                                    href="https://www.hua.com/Member/AccountSetting/PersonInfoManage">个人信息</a></li>
                            <li id="addressListItem"><a href="https://www.hua.com/Member/AccountSetting/AddressList">常用收货人</a>
                            </li>
                            <li id="changePwdItem"><a
                                    href="https://www.hua.com/Member/AccountSetting/ChangePwd">修改密码</a></li>
                            <li id="changeEmailItem"><a href="https://www.hua.com/Member/AccountSetting/ChangeEmail">修改登录名</a>
                            </li>

                            <li id="remindItem"><a href="https://www.hua.com/Member/Remind/">生日/纪念日提醒</a></li>
                            <li id="guanlian"><a href="https://www.hua.com/Member/AccountSetting/Bind">关联QQ/微信账号</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul>
                            <li id="myVirtualAccountItem"><a href="https://www.hua.com/Member/Payment/MyVirtualAccount">我的虚拟账户</a>
                            </li>
                            <li id="myCouponItem"><a href="https://www.hua.com/Member/Payment/MyCoupon">我的优惠券</a></li>
                            <li id="balanceFillItem"><a href="https://www.hua.com/Member/Payment/BalanceFill">在线补款</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul>
                            <li id="guestMessageItem"><a href="https://www.hua.com/Member/CustomerService/GuestMessage">客服留言</a>
                            </li>
                            <li id="tsGuestMessageItem"><a
                                    href="https://www.hua.com/Member/CustomerService/GuestMessage?type=ts">投诉留言</a></li>
...
<div class="footer-nav">
    <a href="https://www.hua.com/">首页</a> <b>|</b> <a href="https://www.hua.com/profile/about.htm"
        ...
        href="https://www.hua.com/profile/links.htm" target="_top">友情链接</a> <b>|</b> <a
...
<footer>
    <div class="auth">
        ...
        <img src="../assets/Images/slogan.png" height="50" width="212"> <a
            href="https://www.hua.com/member/payment/fillbyalipay?order_no=&amp;total_fee=" rel="nofollow"
            target="_top"><img src="../assets/Images/zfb.gif" height="49" width="96"></a>
        <a href="https://www.hua.com/profile/news_20111110.htm" target="_top"><img src="../assets/Images/100.jpg"
                                                                                   height="49" width="150"></a>
        <a href="https://www.hua.com/profile/ICP.htm" rel="nofollow" target="_top"><img src="../assets/Images/bico1.jpg"
                                                                                        alt="ICP" height="46"
                                                                                        width="35"></a>
        ...
        <a href="http://szcert.ebs.org.cn/fab6de6a-ff80-4e63-89e4-cd531170c256" rel="nofollow" target="_top"><img
                alt="工商网监" src="../assets/Images/bico4.jpg" height="46" width="35"></a>
        <a href="http://www.sznet110.gov.cn/netalarm/index.jsp" rel="nofollow" target="_top"><img
                src="../assets/Images/bico3.jpg" alt="网安" height="46" width="35"></a>
    </div>
    <p><a href="https://www.hua.com/profile/ChinaFlowerAssociation.htm" rel="nofollow" target="_top" title="中国花卉协会会员">中国花卉协会会员</a>
        <a href="https://www.hua.com/profile/chinaECA.htm" rel="nofollow" target="_top">中国电子商务协会会员</a> ICP经营许可证：<a
                ...
                href="http://www.miibeian.gov.cn/" rel="nofollow" target="_top">粤ICP备09171662号</a> <span
