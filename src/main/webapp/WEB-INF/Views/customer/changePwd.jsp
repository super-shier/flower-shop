...
<head>
    ...
    <link rel="icon" href="changePwd/favicon.ico" mce_href="/favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="../assets/Css/changePwd.css" media="all">
</head>
<body class="home">
<!-- 顶部导航 -->
            ...
            <div class="box-border member-r">
                ...
                <div class="order-wrap">
                    ...
                    <div class="order-panel">
                        <form action="https://www.hua.com/Member/AccountSetting/ChangePwdSave">

                            <table style="border-collapse: collapse;" cellpadding="5" cellspacing="0" width="100%">
                                <tbody>
                                <tr>
                                    <td align="center" width="82%">
                                        <table border="0" cellpadding="0" cellspacing="4" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" height="20" width="85%"></td>
                                            </tr>
                                            <tr>
                                                <td align="right" height="30" width="15%">您的旧密码：</td>
                                                <td align="left" height="50" width="85%">
                                                    <input name="oldPwd" id="old_pass" value="" size="30" maxlength="40"
                                                           type="password">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" height="50">
                                                    <input name="newPwd1" id="new_pass1" value="" size="30"
                                                           maxlength="40" type="password">
                                                    <font color="#CC0000">*</font>&nbsp;&nbsp;<font color="#bbbbbbb">新密码要求由英文字母
                                                    (a-z大小写均可)、阿拉伯数字 (0-9) 组成且长度为6-16位字符。</font>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" height="30">再次输入新密码：</td>
                                                <td align="left" height="50"><input name="newPwd2" id="new_pass2"
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" height="50">
                                                    <button type="submit" class="btn btn-default btn-sm btn-big">提交
                                                    </button>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="right" height="30"></td>
                                                <td align="left" height="60" valign="top">&nbsp;</td>
                                            </tr>
                                            </tbody>
                                        </table>
                ...
                <ul class="bd">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li class="active" id="changePwdItem"><a
