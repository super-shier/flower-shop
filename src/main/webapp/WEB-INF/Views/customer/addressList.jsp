...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../assets/Css/addressList.css" media="all">
</head>
<body class="home">
<!-- 顶部导航 -->
            ...
            <div class="box-border member-r">
                <div class="address-wrap">
                    <div class="address-add">
                        <a href="javascript:AddressOper('ismember','add')"
                           class="btn btn-default btn-sm btn-big">新增收货地址</a>
                        <span>您已创建 <b>1</b> 个收货地址，最多可建 <b>20</b> 个</span>
                    </div>

                    <div class="address-info">
                        <button type="button" class="close"
                                onclick="if(confirm('确认删除吗？')){AddressOper('1928994','del')}"><span>×</span></button>
                        <h5>zu</h5>
                        <ul class="address-list">
                            <li><b>收货人：</b>zu</li>
                            <li><b>所在地区：</b>山西 &gt; 太原市 &gt; 小店区</li>
                            <li><b>地址：</b>黄河小学18号</li>
                            <li><b>手机：</b>17671751371</li>
                            <li><b>固定电话：</b></li>
                        </ul>
                        <div class="operate">
                            默认&nbsp;<a href="javascript:AddressOper('1928994','edit')">
                            <text>编辑</text>
                        </a>
                        </div>
                    </div>
                ...
                <ul class="bd">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li class="active" id="addressListItem"><a
                                    href="https://www.hua.com/Member/AccountSetting/AddressList">常用收货人</a></li>
