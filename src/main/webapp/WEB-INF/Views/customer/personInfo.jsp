        ...
        <div class="pull-left w970 l230">
            <div class="box-border member-r">
                <div class="member-base-l">
                    <ul class="mb-tab">
                        <li class="active"><a href="https://www.hua.com/Member/AccountSetting/PersonInfoManage">基本信息</a>
                        </li>
                        <li><a href="https://www.hua.com/Member/AccountSetting/HeadPicUpLoad?memberid=2559979">头像照片</a>
                        </li>
                    </ul>
                    ...
                    <form class="form-horizontal" method="post" id="theForm">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-xs-4">
                                <input class="form-control" id="inputName" name="realname" maxlength="40" value="张洋"
                                       type="text">
                            </div>
                        </div>
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-xs-6" id="birthday_container">
                                <select class="form-control" style="width: 90px; display: inline-block;" name="year"
                                        id="year">
                                ...
                                <select class="form-control" style="width: 70px; display: inline-block;" name="month"
                                        id="month">
                                ...
                                <select class="form-control" style="width: 70px; display: inline-block;" name="day"
                                        id="day">
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-xs-10">
                                <p class="form-control-static">846965599@qq.com <input name="email"
                                                                                       value="846965599@qq.com"
                                                                                       type="hidden"></p>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-xs-8">
                                <p class="form-control-static">
                                    176*****371<a href="https://www.hua.com/Member/AccountSetting/EditPhoneAuth"
                                                  class="btn btn-default btn-sm">修改</a> <span
                                        class="text-muted">已验证</span>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-xs-4">
                                <input value="" class="form-control" id="inputPhone" name="tel" size="25" maxlength="30"
                                       type="text">
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-xs-10">
                                <select class="form-control" style="width: 100px; display: inline-block;" name="state"
                                        id="cmbProvince">
                                ...
                                省
                                <select class="form-control" style="width: 100px; display: inline-block;" name="city"
                                        id="cmbCity">
                                    <option value="市辖区">市辖区</option>
                                    <option value="县">县</option>
                                </select>
                                市
                                <select class="form-control" style="width: 100px; display: none;" name="cmbArea"
                                        id="cmbArea">
                        ...
                        <div class="form-group">
                            <div class="col-xs-offset-2 col-xs-10">
                                <button type="button" class="btn btn-default btn-sm btn-submit" onclick="checkFrom()">
                                    提交
                                </button>
                            </div>
                        </div>
            ...
            <div class="box-border">
                ...
                <ul class="bd">
                    ...
                    <li>
                        ...
                        <ul>
                            <li class="active" id="personInfoItem"><a
