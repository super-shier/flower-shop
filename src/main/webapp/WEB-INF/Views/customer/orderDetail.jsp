                                        ...
                                        <table border="0" bordercolor="#FffffF" cellspacing="0" width="98%">
                                            ...
                                            <tr>
                                                <td style="line-height: 130%;" align="center">
                                                    <table style="border-collapse: collapse; line-height: 25px;"
                                                           border="1" bordercolor="#969696" cellpadding="2"
                                                           cellspacing="0" width="98%">
                                                        <tbody>
                                                        <tr>
                                                            <td align="center" bgcolor="#cccccc"><span class="STYLE2">订单处理信息</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left"><p>订单号：<b><font
                                                                    color="#ff0000">221128482</font></b></p></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left">订单处理状态：<font color="#ff0000">待付款</font>&nbsp;&nbsp;
                                                                <a href="javascript:ZhiFu()"><font color="#ff0000"><u>在线支付</u></font></a>&nbsp;&nbsp;<a
                                                                        href="javascript:OrderOper('221128482','cancel');"><font
                                                                        color="#ff0000"><u>取消订单</u></font></a></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left">
                                                                处理说明：<br>
                                                                &nbsp;&nbsp;&nbsp;&nbsp;1、电话不正确、邮箱正确的情况下 2018/4/26
                                                                2:51:00<br>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    ...
                                                    <form method="POST" onsubmit="return FormCheck()"
                                                          action="https://www.hua.com/Member/Order/Detail?orderid=221128482&amp;pt=2018-04-29">
                                                        <table style="border-collapse: collapse; line-height: 25px;"
                                                               border="1" bordercolor="#969696" cellpadding="2"
                                                               cellspacing="0" width="98%">
                                                            <tbody>
                                                            <tr>
                                                                <td align="center" bgcolor="#cccccc"><span
                                                                        class="STYLE2">订单基本信息</span></td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left">
                                                                    ...
                                                                    手机： 176*****371<span>
    &nbsp;&nbsp;&nbsp;电话： 176*****371<br></span>
                                                                    <span>E-mail：</span>846965599@qq.com <input
                                                                        name="Member_email" value="846965599@qq.com"
                                                                        type="hidden">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left">
                                                                    ...
                                                                    <br>
                                                                    姓名：zu <input name="to_name" value="zu"
                                                                                 type="hidden">
                                                                    <br>
                                                                    省市/区： 山西 太原市 小店区 <input name="to_city" value="太原市"
                                                                                            type="hidden">
                                                                    <input name="to_state" value="山西" type="hidden">
                                                                    <br>
                                                                    手机： 17671751371 <input name="to_mobile"
                                                                                           value="17671751371"
                                                                                           type="hidden">
                                                                    <input name="to_tel" value="" type="hidden">
                                                                    <br>
                                                                    地址： 黄河小学18号 <input name="to_address" value="黄河小学18号"
                                                                                       type="hidden">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                    ...
                                                    <table style="border-collapse: collapse;" border="1"
                                                           bordercolor="#969696" cellpadding="2" cellspacing="0"
                                                           width="98%">
                                                        <tbody>
                                                        <tr align="center" bgcolor="#969696">
                                                            <td colspan="4" bgcolor="#cccccc"><span
                                                                    class="STYLE2">商品信息</span></td>
                                                        </tr>
                                                        <tr align="center">
                                                            <td>商品名称</td>
                                                            <td>价格</td>
                                                        ...
                                                        <tr align="center">
                                                            <td>
                                                                <a href="https://www.hua.com/product/9012009.html"
                                                                   target="_top">
                                                                    <img src="../assets/Images/9012009.jpg_80x87.jpg"
                                                                         height="56" width="50">
                                                                </a>
                                                                <a href="https://www.hua.com/product/9012009.html"
                                                                   target="_top">
                                                    ...
                                                    <br><input name="order_amount" id="order_amount" value="298"
                                                               type="hidden">
                                                </td>
                                            </tr>
                                            </tbody>
