...
<head>
    ...
    <meta name="description"
          content="会员中心-中国鲜花礼品网,专业提供鲜花礼品网上购物,全国连锁网上花店,鲜花蛋糕礼品3小时送达1000多城市鲜花网,选中国鲜花礼品网(花礼网)-中国鲜花网领先品牌,Hua.com专注鲜花速递服务10年,销量稳居鲜花礼品类网站首位！鲜花网提供24小时订鲜花，同城送花、异地送花服务,网上订花后最快3小时即可将鲜花快递上门,送花网站覆盖中国900多城市！">
...
<nav class="common">
    <div class="container">
        <div class="categorys dropdown">
            <h3 aria-expanded="false" class="categorys-title" data-hover="dropdown" data-delay="0">
    ...
    <div class="wrapper about">
        ...
        <div class="pull-left w970 l230">
            <div class="box-border member-r">
                ...
                <div class="member-info">
                    ...
                    <div class="my-counts">
                        <a href="https://www.hua.com/member/order/?zt=1&amp;sj=0">
                            <b><span class="ico ico-m-pay"></span></b>待付款 <span class="text-primary">2</span>
                        </a>

                        <a href="https://www.hua.com/member/order/?zt=3&amp;sj=0">
                            <b><span class="ico ico-m-receive"></span></b>今日配送 <span class="">0</span>
                        </a>

                        <a href="https://www.hua.com/member/order/?zt=4&amp;sj=0">
                            <b><span class="ico ico-m-comment"></span></b>待评价 <span class="">0</span>
                        </a>
                    </div>
                    <ul class="my-stuffs list-unstyled">
                        <li><a href="https://www.hua.com/member/payment/myvirtualaccount">余额: 0</a></li>
                        <li><a href="https://www.hua.com/member/payment/myscores">积分: 0</a></li>
                        <li><a href="https://www.hua.com/member/payment/mycoupon">优惠券: 0</a></li>
                    </ul>
                    ...
                    <div class="verify-mobile">
                        ...
                        <a class="btn btn-primary btn-sm"
                           href="https://www.hua.com/member/accountsetting/editphoneauth">修改 <span
                ...
                <div class="how-vip">
                    <h3>如何成为VIP</h3>
                    <p>您在hua.com成功购物一次，送货完毕后系统将自动将您的会员级别升至VIP，享受鲜花最高9折优惠。<br>会员级别将在送货完毕后一个工作日内完成升级，重大节日（即情人节、母亲节、七夕节、圣诞节和春节）需二个工作日左右。
                    </p>
                </div>

                <div class="member-panel">
                    <div class="hd">
                        <a href="https://www.hua.com/Member/Order/MyAttention">查看更多收藏 &gt;&gt; </a>
                        <h4>我的收藏</h4>
                    </div>
                    <div class="bd">

                        <p align="center"></p>
                        <center><font color="red"><b>您好,您没有收藏的记录</b></font></center>
                        <p></p>
                    </div>
                </div>
            </div>
        ...
        <div class="pull-left w210 r970" id="containerBody">
            <div class="box-border">
                ...
                <ul class="bd">
                    <li class="active" id="memberCenterItem"><a href="https://www.hua.com/Member/MemberCenter/"
                                                                style="font-size: 12px;"><span
                            class="ico ico-member1"></span>会员首页</a></li>
                    <li>
