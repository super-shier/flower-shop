...
<div class="container">
    ...
    <div class="wrapper about">
        ...
        <form action="https://www.hua.com/Member/Order/MyAttention" method="get" id="infoForm">
                ...
                <div class="box-border member-r">
                    ...
                    <div class="attention-all">
                        <div class="all-l">
                            <div class="checkbox">
                                <label>
                                    <input id="selectall" onchange="checkselect();" type="checkbox"> 全选
                                </label>
                            </div>
                            ...
                            <input name="method" id="method" value="cancled" type="hidden">
                        </div>
                    </div>
                    <div class="attention-list">
                        <ul class="attention-item">
                            <li class="checkbox">
                                <label>
                                    <input class="singleChecked" name="product_code" value="9012009" type="checkbox">
                                </label>
                            </li>
                            <li class="img-box">
                                <a href="https://www.hua.com/product/9012009.html"><img
                                        src="../assets/Images/9012009.jpg_80x87.jpg" alt="忘情巴黎-33枝红玫瑰，石竹梅围绕"
                                        width="150"></a>
                            </li>
                            <li class="product-title">
                                <p><a href="https://www.hua.com/product/9012009.html">忘情巴黎-33枝红玫瑰，石竹梅围绕</a></p>
                                <span class="cc">加收藏时间：2018/4/26 1:32:34</span>
                            </li>
                            <li class="price">
                            ...
                            <li class="operate">
                                <a href="https://www.hua.com/Shopping/AddtoCart?product_code=9012009"
                                   class="btn btn-default btn-sm btn-m"><span class="ico ico-cart-m"></span>加入购物车</a>
                                <a href="https://www.hua.com/Member/Order/MyAttention?action=cancled&amp;product_code=9012009"
                                   onclick="return checkDelete();">取消收藏</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <ul class="bd">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li class="active" id="myAttentionItem"><a
                                    href="https://www.hua.com/Member/Order/MyAttention">我的收藏</a></li>
