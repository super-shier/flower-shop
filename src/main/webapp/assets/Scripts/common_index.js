...
(function () {
    ...
    hm.src = "https://hm.baidu.com/hm.js?5f4aa36509ee08b412f4647f6d4f1749";
 ...
 */
        (function (window) {
            var i, support, Expr, getText, isXML, tokenize, compile, select, outermostContext, sortInput, hasDuplicate,
                ...
                push_native = arr.push, push = arr.push, slice = arr.slice, indexOf = function (list, elem) {
    ...
    var ralpha = /alpha\([^)]*\)/i, ropacity = /opacity\s*=\s*([^)]*)/, rdisplayswap = /^(none|table(?!-c[ea]).+)/,
    ...
    $.fn.dropdownHover = function (options) {
        ...
        return this.each(function () {
            var $this = $(this), $parent = $this.parent(),
                defaults = {delay: 500, hoverDelay: 0, instantlyCloseOthers: true}, data = {
...
$(document).ready(function () {
    ...
    $.fn.iVaryVal = function (iSet, CallBack) {
        iSet = $.extend({Minus: $(".J_minus"), Add: $(".J_add"), Input: $(".J_input"), Min: 1, Max: 9999}, iSet);
        var C = null, O = null;
        var $CB = {};
    ...
    $(function () {
        $(".input-num").iVaryVal({}, function (value, index) {
        })
    });
    $(function () {
        $(".cate-cake").hover(function () {
            $(".right-menu", this).show();
            $(this).addClass("open")
        });
        $(".cate-cake").mouseleave(function () {
...
function setIsFrom() {
    ...
    var rmd = Math.random();
    sid = reqUrlParam("sid");
    uid = reqUrlParam("u_id");
    sid = sid.trim();
    uid = uid.trim();
    if ((sid != "") && (sid.toLowerCase() != "emar") && (sid.toLowerCase() != "linktech")) {
        $.get("/home/from?rmd=" + rmd, "sid=" + sid + "&u_id=" + uid, null)
    } else {
        if ((sid != "") && ((sid.toLowerCase() == "emar") || (sid.toLowerCase() == "linktech"))) {
            var myheight = 0;
            var mywidth = 0;
